...
| `add-asset-dialog.tsx` | 203 | **Reaproveitar parcialmente.** Recebe o formulário por `FormProvider`, montado na página; o formulário de transação já monta o próprio formulário a cada abertura |
