...
* **sign-up:** token que autentica de imediato, e-mail já cadastrado em qualquer caixa, sign-ups concorrentes para o mesmo e-mail (exatamente um cria conta e carteira), fronteiras de 15 code points e 72 bytes, senha em branco, espaços preservados como parte da senha;
...
* **sign-out.**
* **exclusão de conta:** remove a conta com carteira, ativos e transações, sem tocar em outra conta, e encerra a sessão; senha errada não remove nada;
