...
| A política de senha só aparecia depois do erro (3.3.2) | dica com os requisitos ligada por `aria-describedby` à senha do sign-up e à nova senha da conta; hoje é a lista de `PasswordRequirements`, que marca cada requisito cumprido e diz o estado em texto |
